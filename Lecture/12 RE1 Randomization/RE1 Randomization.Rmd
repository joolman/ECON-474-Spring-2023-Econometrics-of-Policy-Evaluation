...
```{r incentive group}
df = df %>%
  mutate(incentive = ifelse(any == 0,
                            "No Incentive",
                            "Incentive"))
df$incentive = factor(df$incentive, 
                      levels = c("No Incentive",
                                 "Incentive"))
df$incentive %>% head
```
...
```{r fig3a}
fig3a = ggplot(df_fig3_a, aes(x = group, y = beta)) +
  ...
  geom_errorbar(aes(ymin = `2.5 %`,
                ...
                width = 0.1,
                linewidth = 1.1) + 
  labs(x = "", title = "Effect of Receiving Some Incenitve",
       y = "Percentage Learning HIV Results") +
...
df$inc_group = df$tinc %>%
  cut(breaks = c(-1, 0, 0.1, 0.2, 0.3, 0.5, 1, 1.5, 2, 2.5, 3))
...
fig3b = ggplot(df_fig3_b, aes(x = group, y = beta)) +
  ...
  geom_errorbar(aes(ymin = `2.5 %`,
                ...
                width = 0.1,
                linewidth = 1.1) + 
  labs(x = "", title = "Effect of Total Amount of Incenitve",
       y = "Percentage Learning HIV Results") +
  scale_y_continuous(breaks = seq(0, 1, by = 0.2),
                     limits = c(0,1)) +
  theme_minimal()
