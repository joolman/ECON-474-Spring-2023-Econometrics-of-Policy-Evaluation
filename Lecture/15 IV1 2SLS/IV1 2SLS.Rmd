...
hiv = read_dta("C:/Users/johnj/Dropbox/Julian/Academia/UIUC/Semester 12 Spring 2023/ECON474sp23/Data/IV1 Thornton 2008 nonparametricvct.dta")
...
```{r tab 6}
fit6 = feols(c(got, got_hiv) ~ any*male*hiv2004 + tinc*male*hiv2004 +
               I(tinc^2)*male*hiv2004 - male:hiv2004 + age + I(age^2) +
               simaverage + rumphi,
             data = hiv,
             subset = ~ hadsex12 == 1,
             cluster = ~ villnum)
...
fit6_no_clust = feols(got ~ any*male*hiv2004 + tinc*male*hiv2004 +
               I(tinc^2)*male*hiv2004 - male:hiv2004 + age + I(age^2) +
               simaverage + rumphi,
             data = hiv,
             subset = ~ hadsex12 == 1)
...
```{r tab6 lm}
fit_lm = lm(got ~ any*male*hiv2004 + tinc*male*hiv2004 +
               I(tinc^2)*male*hiv2004 - male:hiv2004 + age + I(age^2) +
               simaverage + rumphi,
             data = hiv,
...
```{r tab 7 col 4}
fit7_4 = feols(numcond ~ hiv2004 + male + age + I(age^2) +
               simaverage + rumphi| got + got_hiv ~ any*male*hiv2004 + tinc*male*hiv2004 +
               I(tinc^2)*male*hiv2004 - male:hiv2004 - male - hiv2004,
      data = hiv,
      subset = ~ hadsex12 == 1,
      cluster = ~ villnum)
...
```{r tab 6 col 4 just identified}
 feols(numcond ~ hiv2004 + male + age + I(age^2) +
               simaverage + rumphi| got + got_hiv ~ any + distvct,
      data = hiv,
      subset = ~ hadsex12 == 1,
      cluster = ~ villnum)
```
...
```{r tab 6 col 4 over identified 1}
 ...
 feols(numcond ~ hiv2004 + male + age + I(age^2) +
               simaverage + rumphi| got + got_hiv ~ any + distvct + tinc,
      data = hiv,
      subset = ~ hadsex12 == 1,
      cluster = ~ villnum)
```
...
```{r tab 6 col 4 over identified 2}
 ...
 feols(numcond ~ hiv2004 + male + age + I(age^2) +
               simaverage + rumphi| got + got_hiv ~ any + distvct + tinc + any:hiv2004,
      data = hiv,
      subset = ~ hadsex12 == 1,
      cluster = ~ villnum)
```
